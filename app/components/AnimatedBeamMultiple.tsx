...
export function AnimatedBeamMultipleOutputDemo({
  ...
  return (
    <div
      className={cn(
        "relative flex h-full w-full items-center justify-center overflow-hidden rounded-lg border bg-background p-10 md:shadow-xl ",
        className
      )}
      ref={containerRef}
    >
  ...
  container: () => (
    ...
    >
      ...
      <polygon
        ...
        transform="matrix(1.8176867,0,0,1.924421,-41.0962,-43.850091)"
        style={{
          fill: "#20c2ef",
          stroke: "#394d54",
          strokeWidth: 3,
